...
setInterval(debouncedHandleShadowRoots, 3000)

function findDivsWithAdSlugAndContent(shadowRoot) {
  const result = [];
  ['.card-outer:has(.ad-slug)', '.card-content:has(.ad-slug)'].forEach(val => {
...
var cssPath = "https://raw.githubusercontent.com/jqwel/extensions/refs/heads/main/focus_booster/css/all.css"
if (chrome) {
